...
(async () => {
  ...
  async function showBalances() {
    ...
    const token = new ethers.Contract(process.env.TOKEN, erc20Abi, provider);

    const decimals = await token.decimals();
    const usdtBal = await token.balanceOf(address);
    const usdtFormatted = Number(usdtBal) / 10 ** decimals;

    console.log("\n===============================");
    console.log("Address :", address);
    console.log("USDT    :", usdtFormatted);
    console.log("BNB     :", bnbFormatted);
    console.log("===============================\n");
  }
...
// ======================================================
// SELURUH SCRIPT ASLI DIMASUKKAN DI SINI TANPA DIUBAH
// ======================================================
